...
contract LockManager {
    ...
    mapping(uint => uint) public  fnftIdToLockId;
     ...
     */
    function fnftIdToLock(uint fnftId) public view  returns (IRevest.Lock memory) {
    ...
    function unlockFNFT(uint fnftId, address sender) external returns (bool) {
        ...
        // }
        // else 
        // if (typeLock == IRevest.LockType.ValueLock) {
        //     bool unlockState;
